...
try {
  ...
  $templatePath = __DIR__ . "/templates/list_obese_overweight.xlsx";
  ...
  $sheet->setTitle('Overweight Obese');
  ...
  if ($totalChildren === 0) {
    ...
    $sheet->setCellValue("A{$startRow}", 'No overweight or obese children found for the selected barangay, month, and year.');
  ...
  $filename = sprintf(
    'Overweight_Obese_Children_0_59_Months_%s_%04d_%02d.xlsx',
  ...
  audit_log(
    ...
    $userId,
    'REPORT_EXPORTED',
    'obese_overweight_0_59_months',
    (string)$barangayId,
    "Exported Overweight/Obese 0-59 Months, rows={$totalChildren}, measurements_marked={$exportedCount}"
  );
